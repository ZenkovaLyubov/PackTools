...
var _printResultJs = require("./jointLib/printResult.js");
var _getDateDiffJs = require("./getDateDiff.js");
var _getDateDiffJsDefault = parcelHelpers.interopDefault(_getDateDiffJs);
var _timerMinusJs = require("./timerMinus.js");
var _timerMinusJsDefault = parcelHelpers.interopDefault(_timerMinusJs);
var _setTimeObjJs = require("./setTimeObj.js");
var _setTimeObjJsDefault = parcelHelpers.interopDefault(_setTimeObjJs);
var _formToggleJs = require("./formToggle/formToggle.js");
var _howlerJs = require("./howler.js");
...
calcTab.addEventListener("click", ()=>(0, _formToggleJs.FormToggle)(formTimer, form));
timerTab.addEventListener("click", ()=>(0, _formToggleJs.FormToggle)(form, formTimer));
//калькулятор дат
form.onsubmit = (event)=>{
    ...
    if (!firstDate || !secondDate) (0, _printResultJs.printError)("Пожалуйста, укажите даты!");
    else {
        const dateDiff = (0, _getDateDiffJsDefault.default)(firstDate, secondDate);
        (0, _printResultJs.printResult)(dateDiff, "datecalc");
    }
};
//таймер
...
start.addEventListener("click", function(event) {
    ...
    if (userHours > 0 || userMinutes > 0 || userSeconds > 0) {
        ...
        let dt = (0, _setTimeObjJsDefault.default)(userHours, userMinutes, userSeconds);
        (0, _printResultJs.printResult)(dt, "timer");
        timerId = setInterval(timerFunc, 1000);
        function timerFunc() {
            (0, _printResultJs.printResult)(dt, "timer");
            dt = (0, _timerMinusJsDefault.default)(dt, 1);
            (0, _printResultJs.printResult)(dt, "timer");
            if (dt.toFormat("HH mm ss") == "00 00 00") {
                clearInterval(timerId);
                start.removeAttribute("disabled");
                calcTab.removeAttribute("disabled");
                (0, _printResultJs.printError)("Время вышло!");
        ...
        clearInterval(timerId);
        (0, _printResultJs.printError)("Укажите время для таймера");
    }
});
stop.addEventListener("click", function(event) {
    event.preventDefault();
    clearInterval(timerId);
    (0, _printResultJs.printError)("Таймер остановлен");
    start.removeAttribute("disabled");
    calcTab.removeAttribute("disabled");
});

},{"./jointLib/printResult.js":"95SBH","./getDateDiff.js":"1bxDH","./timerMinus.js":"dfBzn","./setTimeObj.js":"jTpjM","./formToggle/formToggle.js":"lqJgf","./howler.js":"9RhZw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"95SBH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "printError", ()=>printError);
parcelHelpers.export(exports, "printResult", ()=>printResult);
const result = document.getElementById("result");
const printError = (textErr)=>{
    result.innerText = textErr;
};
const printResult = (obj, key)=>{
    if (key === "datecalc") result.innerText = `Год: ${obj.years} Месяц: ${obj.months} День: ${obj.days}`;
    if (key === "timer") result.innerText = obj.toFormat("HH : mm : ss");
};
...
},{}],"1bxDH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _luxonJs = require("./luxon.js");
function getDateDiff(dateFrom, dateTo) {
    const dateFromObj = (0, _luxonJs.DateTime).fromISO(dateFrom);
    const dateToObj = (0, _luxonJs.DateTime).fromISO(dateTo);
    return dateFromObj.diff(dateToObj, [
        "years",
        "months",
        "days"
    ]).toObject();
...
},{"./luxon.js":"lp8fO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lp8fO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DateTime", ()=>DateTime);
parcelHelpers.export(exports, "Duration", ()=>Duration);
parcelHelpers.export(exports, "FixedOffsetZone", ()=>FixedOffsetZone);
parcelHelpers.export(exports, "IANAZone", ()=>IANAZone);
parcelHelpers.export(exports, "Info", ()=>Info);
parcelHelpers.export(exports, "Interval", ()=>Interval);
parcelHelpers.export(exports, "InvalidZone", ()=>InvalidZone);
parcelHelpers.export(exports, "LocalZone", ()=>LocalZone);
parcelHelpers.export(exports, "Settings", ()=>Settings);
parcelHelpers.export(exports, "Zone", ()=>Zone) //# sourceMappingURL=luxon.js.map
;
let _exp = {};
...
function padStart(input, n = 2) {
    if (input.toString().length < n) return ("0".repeat(n) + input).slice(-n);
 ...
 */ class IANAZone extends Zone {
   ...
   */ static isValidZone(zone) {
    ...
    /** @override **/ offset(ts) {
        const date = new Date(ts), dtf = makeDTF(this.name), [year, month, day, hour, minute, second] = dtf.formatToParts ? partsOffset(dtf, date) : hackyOffset(dtf, date), // work around https://bugs.chromium.org/p/chromium/issues/detail?id=1025564&can=2&q=%2224%3A00%22%20datetimeformat
 ...
 */ class Duration {
   ...
   */ plus(duration) {
        ...
        for (const k of orderedUnits)if (hasOwnProperty(dur.values, k) || hasOwnProperty(this.values, k)) result[k] = dur.get(k) + this.get(k);
        return clone(this, {
            values: result
        }, true);
    }
   ...
   */ equals(other) {
        ...
        for (const u of orderedUnits){
            if (this.values[u] !== other.values[u]) return false;
        }
        return true;
    }
}
   ...
   */ static fromISO(text, opts) {
        ...
        if (s && e) {
            ...
            if (start.isValid) {
                ...
                if (dur1.isValid) return Interval.before(end, dur1);
            }
        }
...
function fixOffset(localTS, o, tz) {
    ...
    let utcGuess = localTS - o * 60000; // Test whether the zone matches the offset for this ts
...
function adjustTime(inst, dur) {
    ...
    if (keys.indexOf("milliseconds") === -1) keys.push("milliseconds");
...
function quickDT(obj, zone) {
    ...
    for (const u of orderedUnits$1)if (isUndefined(obj[u])) obj[u] = defaultUnitValues[u];
 ...
 */ class DateTime {
  ...
  */ minus(duration) {
   ...
   */ hasSame(otherDateTime, unit) {
        if (!this.isValid) return false;
        if (unit === "millisecond") return this.valueOf() === otherDateTime.valueOf();
        else {
...
exports.default = _exp;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dfBzn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function timerMinus(objTime, countSeconds) {
    return objTime.minus({
        seconds: countSeconds
    });
}
exports.default = timerMinus;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jTpjM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _luxonJs = require("./luxon.js");
function setTimeObj(hours, minutes, seconds) {
    return (0, _luxonJs.DateTime).fromObject({
        hour: hours,
        minutes: minutes,
        second: seconds
    });
}
exports.default = setTimeObj;

},{"./luxon.js":"lp8fO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lqJgf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FormToggle", ()=>FormToggle);
var _printResultJs = require("../jointLib/printResult.js");
function FormToggle(form1, form2) {
    form1.style.display = "none";
    form2.style.display = "block";
    (0, _printResultJs.printError)("");
}

},{"../jointLib/printResult.js":"95SBH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9RhZw":[function(require,module,exports) {
var global = arguments[3];
/*!
 *  howler.js v2.2.3
 *  howlerjs.com
...
},{}]},["3Unyy","bDbGG"], "bDbGG", "parcelRequire5b12")
